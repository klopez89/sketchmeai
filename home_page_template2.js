	  ...
	  <div class="relative isolate pt-4">
	    ...
	    <div class="py-24 sm:py-32 lg:pb-20">
	      <div class="lg:flex justify-between mx-auto max-w-7xl px-6 lg:px-8 items-center">
	        <div class="mx-auto max-w-2xl text-center min-w-[40%]">
	        ...
	        <div class="mt-4 flow-root sm:mt-4">
	          <div class="m-5 lg:m-20">
	            <img src="https://storage.googleapis.com/sketchme_site/homepage_main_image%402x.png" alt="App screenshot" width="2432" height="1442" class="">
	          </div>
	        </div>
	      </div>
	    </div>
