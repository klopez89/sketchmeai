function consoleHtml() {
    ...
    <div x-data="{ open: false }" @keydown.window.escape="open = false">
        ...
        <div class="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
            ...
            <button onclick="showPaymentModal()">To Payment</button>
                    ...
                    <div class="max-w-2xl mx-auto bg-white p-7 rounded-lg shadow-lg w-full relative">
                        ...
                        <div class="mb-1">
                            ...
                            <div class="relative">
                                ...
                                <button class="bg-black text-white font-semibold px-8 py-[0.6em] rounded shadow ml-2" onclick="userWantsToPay(event)">Pay</button>
                            </div>
                        </div>
