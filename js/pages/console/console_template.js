    ...
    <div x-data="{ open: false }" @keydown.window.escape="open = false">
        ...
        <div class="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
                ...
                <button class="cursor-pointer rounded-md flex-grow-0 flex-shrink-0 text-center bg-black px-2 max-h-[50px] text-sm text-white shadow-sm hover:bg-gray-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">See Prompt Examples</button>
                ...
                <div id="payment-modal" class="hidden absolute bg-black bg-opacity-90 h-full w-full z-10 flex flex-col justify-center transition duration-500 opacity-0">
                    ...
                    <div class="max-w-2xl mx-auto bg-white p-7 rounded-lg shadow-lg w-full relative">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="mb-0 text-gray-400">~ $3.40 to $6.40 / trained model (for 10 vs 20 images)</p>
