...
function toggleImageSelectability() {
    ...
    if (isSelectable) {
        ...
        selectToShareButton.classList.remove("bg-transparent", "text-black", "hover:bg-gray-200");
        ...
        selectToShareButton.classList.add("bg-transparent", "text-black", "hover:bg-gray-200");
