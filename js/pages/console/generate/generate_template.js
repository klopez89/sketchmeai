    ...
    <div class="mx-auto w-full h-full grow xl:flex">
        ...
        <div class="bg-gray-200 shrink-0 border-t border-gray-200 px-4 pb-4 pt-4 sm:px-6 xl:w-96 lg:border-l lg:border-t-0 lg:pr-8 xl:pr-6">
            ...
            <form class="generate-form h-full" id="generateForm" action="https://whollyai-5k3b37mzsa-ue.a.run.app/generate" method="get">
                ...
                <div class="sm:col-span-3 flex justify-center" id="gen-button-container">
                    <input type="submit" value="Generate" class="rounded-md flex-grow-0 flex-shrink-1 text-center bg-blue-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">
                </div>

                <div class="sm:col-span-3" id="gen-count-field-container">
                    <label for="lora-scale" class="block text-sm font-medium leading-6 text-gray-900"># of Generations</label>
                    <div class="mt-2">
                        <input type="number" name="lora-scale" id="lora-scale" min="1" max="10" step="1" autocomplete="family-name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" value="1">
                    </div>
                </div>
