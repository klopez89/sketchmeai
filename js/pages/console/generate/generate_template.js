				...
				<div class="accordion-body px-0 pb-4 grid grid-cols-6 gap-x-5 gap-y-5 sm:grid-cols-6">
					...
					<div class="col-span-full" id="igm2img-field-container">
						<div id="ref-img-div-container" class="flex items-center justify-center pt-1 pb-2">
							<button id="ref-img-button" class="relative flex flex-col items-center justify-center block w-[8em] h-[8em] md:w-[16em] md:h-[16em] rounded-lg border-2 md:border-4 border-dashed border-gray-300 px-12 py-6 text-center hover:border-gray-400 text-gray-300 hover:text-gray-400">
								...
								<div class="flex flex-col items-center">		
									<i id="upload-icon" class="fa text-3xl md:text-6xl fa-images" aria-hidden="true"></i>
					...
					<div class="col-span-full grid grid-cols-6 gap-x-6 gap-y-2">
						...
						<div class="col-span-full" id="toggle-ays-field-container">
							<div class="flex items-center justify-between">
								...
								<button id="ays-toggle-button" type="button" onclick="toggleAysPressed(event)" class="enabled bg-black relative inline-flex h-6 w-10 md:h-11 md:w-20 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-black-600 focus:ring-offset-2" role="switch" aria-checked="false" aria-labelledby="availability-label" aria-describedby="availability-description">
									<!-- Enabled: "translate-x-5 or x-10 if md", Not Enabled: "translate-x-0" -->
									<span aria-hidden="true" class="translate-x-5 md:translate-x-10 pointer-events-none inline-block h-5 w-5 md:h-10 md:w-10 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out"></span>
								</button>
							</div>
						</div>
