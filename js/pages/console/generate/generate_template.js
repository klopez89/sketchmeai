...
function newGridItemHTML(gen_id, gen_string="") {
    ...
    <div class="relative rounded-lg overflow-hidden" generation-id="${gen_id}" gen-info="${gen_string}">
        <div class="group aspect-h-10 aspect-w-10 block w-full relative">
            ...
            <img src="" alt="" class="object-cover group-hover:opacity-95 transition-opacity opacity-0 duration-200 cursor-pointer data-[te-lightbox-disabled]:cursor-auto" onclick="goingToLightbox()">
            ...
            <div class="bg-gray-100 px-0 py-0 md:flex-1">
                <div class="bg-gray-100">
                    <div id="collection-grid-container" class="relative mx-auto max-w-7xl px-2 py-6 overflow-y-auto">
                        ...
                        <div data-te-lightbox-init id="collection-grid" role="list" class="grid grid-cols-2 gap-x-2 gap-y-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4" @click.away="clickedOutsideOfGenMenu()"></div>
