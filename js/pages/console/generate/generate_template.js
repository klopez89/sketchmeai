...
function dummyGridHTML() {
    ...
    <div class="mx-auto w-full h-full grow md:flex">
        ...
        <div class="bg-gray-100 pb-4 pt-4 min-w-[320px] md:max-w-[400px] max-w-full border-r border-gray-300">
                ...
                <div class="mt-0 grid grid-cols-1 gap-x-6 gap-y-2 sm:grid-cols-6">
                    <div class="col-span-full" id="prompt-field-container">
						<div class="flex justify-between items-center">
							...
							<button onclick="basicPromptExampleButtonPressed()" class="underline text-sm text-gray-700 hover:text-gray-900">Example</button>
						</div>
                        <div class="mt-2">
