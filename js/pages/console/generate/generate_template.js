        ...
        <div class="bg-gray-200 shrink-0 border-t border-gray-200 px-4 pb-4 pt-4 sm:px-6 xl:w-96 lg:border-l lg:border-t-0 lg:pr-8 xl:pr-6">
            ...
            <form class="generate-form h-full" id="generateForm" action="https://whollyai-5k3b37mzsa-ue.a.run.app/generate" method="get">
                ...
                <div class="col-span-full flex justify-center" id="gen-button-container">
                    <button class="rounded-md flex-grow text-center bg-blue-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600" onClick="generateButtonPressed()">Generate</button>
                </div>
                ...
                <div class="col-span-full" id="igm2img-field-container">
                    <label for="img2imgurl" class="block text-sm font-medium leading-6 text-gray-900">Image2Image Url</label><div class="mt-2">
                ...
                <div class="sm:col-span-3" id="ps-field-container">
                    ...
                    <div class="mt-2">
                    <input type="number" name="prompt-strength" id="prompt-strenth" min="0.0" max="1.0" step="0.1" value="0.8" autocomplete="family-name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div><div class="sm:col-span-3" id="lora-field-container">
                ...
                </div><div class="col-span-full" id="models-field-container">
                    <label for="models" class="block text-sm font-medium leading-6 text-gray-900">Models</label><div class="mt-2">
                ...
                </div></div><div class="col-span-full" id="same-seed-field-container"><div class="relative flex gap-x-3">
