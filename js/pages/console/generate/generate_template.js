...
function newGridItemHTML(gen_id, gen_string="") {
    ...
    <li class="relative rounded-lg overflow-hidden" generation-id="${gen_id}" gen-info="${gen_string}">
        <div class="group aspect-h-10 aspect-w-10 block w-full relative">
            <img src="" alt="" class="pointer-events-none object-cover group-hover:opacity-75 transition-opacity opacity-0 duration-200">
        ...
        <div class="flex-1 xl:flex">
            <div class="bg-gray-100 px-0 py-0 xl:flex-1">
                <div class="bg-gray-100">
                    <div data-te-lightbox-init id="collection-grid-container" class="relative mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 overflow-y-auto">
