    ...
    <li class="relative rounded-lg overflow-hidden" generation-id="${gen_id}" gen-info="${gen_string}">
        <div class="group aspect-h-10 aspect-w-10 block w-full relative">
            ...
            <div id="copy-container" class="bg-transparent pointer-events-none">
                <button id="copy-button" class="absolute bottom-2 right-2 p-2 text-xl text-white border-2 border-white opacity-0 hover:opacity-100 hover:bg-gray-800 rounded-lg pointer-events-auto flex items-center justify-center">
