                ...
                <div class="bg-gray-100 h-full relative">
					...
					<div class="selection-bar absolute bottom-0 w-full right-0 py-5 px-5 bg-gray-800 bg-opacity-85 z-20 hidden">
						<div class="float-right space-x-4 flex">
							...
							<button type="button" class="ml-3 inline-flex items-center rounded-md px-3 py-2 text-sm shadow-sm bg-red-500 text-white bg-white hover:bg-gray-50" onclick="deleteSelectedPressed()" id="deleteSelectedButton">Delete</button>
