...
function newGridItemHTML(gen_id, gen_string="") {
    ...
    <li class="relative rounded-lg overflow-hidden" generation-id="${gen_id}" gen-info="${gen_string}">
        <div class="group aspect-h-10 aspect-w-10 block w-full relative">
            ...
            <div id="pause-container" class="bg-transparent pointer-events-none">
                <button class="absolute bottom-2 right-2 text-xl text-white border border-white pointer-events-auto flex items-center justify-center">
