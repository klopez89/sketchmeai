function dummyGridHTML() {
    ...
    <div class="bg-gray-100 h-full relative flex justify-center">
        <div id="collection-grid-container" class="absolute mx-auto max-w-5xl px-8 py-8 overflow-y-auto h-full w-full bg-gray-100 transform transition-all duration-200 ease-in-out">
            <div class="relative">
        ...
        <!-- New div with a form -->
        <div id="new-form-container" class="hidden absolute opacity-0 mx-auto max-w-5xl px-8 py-8 overflow-y-auto h-full w-full bg-gray-100 transition duration-500 opacity-0">
                ...
                <div id="accordionExample5">
                	<div class="rounded-t-lg bg-transparent">
						<h2 class="mb-0" id="headingOne5">
								<button class="group relative flex w-full items-center rounded-t-[15px] border-0 bg-transparent pt-2 text-center text-sm text-gray-700 transition [overflow-anchor:none] hover:z-[2] focus:z-[3] focus:outline-none [&:not([data-te-collapse-collapsed])]:bg-transparent [&:not([data-te-collapse-collapsed])]:text-gray-400" type="button" data-te-collapse-init="" data-te-target="#collapseOne5" aria-expanded="false" aria-controls="collapseOne5" data-te-collapse-collapsed="">
