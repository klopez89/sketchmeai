function dummyGridHTML() {
    ...
    <div class="bg-gray-100 h-full relative flex justify-center">
        <div id="collection-grid-container" class="absolute mx-auto max-w-5xl px-2 py-6 overflow-y-auto h-full w-full bg-gray-100 transform transition-all duration-200 ease-in-out">
            <div class="relative">
        ...
        <!-- New div with a form -->
        <div id="new-form-container" class="hidden absolute opacity-0 mx-auto max-w-5xl px-2 py-6 overflow-y-auto h-full w-full bg-gray-100 transition duration-500 opacity-0">
