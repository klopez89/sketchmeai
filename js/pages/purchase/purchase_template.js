						...
						<div class="bg-white px-2 py-2 sm:px-4">
							<div class="-ml-4 -mt-4 flex flex-wrap items-center justify-between sm:flex-nowrap">
								...
								<div class="ml-4 mt-4 flex-shrink-0">
									<form action="https://sketchmeaibackend-sxgjpzid6q-uk.a.run.app/create-checkout-session?price-id=price_1NlaTnLBuf172mCOWBlXjIhS" method="POST">
...
function uploadContext_HTML() {
	...
	<ul role="list" id="uploadEntryContainer" class="flex flex-wrap gap-2 pb-7 pt-6 px-8 justify-center">
	</ul>
